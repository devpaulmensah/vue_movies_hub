                      ...
                      <div class="pt-5 pb-6 px-5">
                          ...
                          <div class="mt-6">
                            <nav class="grid gap-y-8">
                                <nuxt-link to="/" class="-m-3 p-3 flex items-center rounded-md hover:bg-gray-50">
                                ...
                                <nuxt-link to="top-rated" class="-m-3 p-3 flex items-center rounded-md hover:bg-gray-50">
                                ...
                                <nuxt-link to="popular" class="-m-3 p-3 flex items-center rounded-md hover:bg-gray-50">
                                ...
                                <nuxt-link to="upcoming" class="-m-3 p-3 flex items-center rounded-md hover:bg-gray-50">
                                  <svg class="flex-shrink-0 h-6 w-6 text-indigo-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                                ...
                                <a href="https://github.com/devpaulmensah" target="_blank" class="-m-3 p-3 flex items-center rounded-md hover:bg-gray-50">
                                  <svg class="flex-shrink-0 h-6 w-6 text-indigo-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
                                  </svg>
                                  <span class="ml-3 text-base font-medium text-gray-900">
